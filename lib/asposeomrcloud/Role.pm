...
has _cfg => ( is => 'ro',
              isa => 'asposeomrcloud::Configuration',
              default => sub { asposeomrcloud::Configuration->new() },
              );

has version_info => ( is => 'ro',
                      isa => 'HashRef',
                      default => sub { {
                          app_name => 'Aspose.OMR for Cloud API Reference',
                          app_version => '1.1',
...
sub _build_af {
	...
	return asposeomrcloud::ApiFactory->new(%args);
}

=head1 NAME

asposeomrcloud::Role - a Moose role for the Aspose.OMR for Cloud API Reference

=head2 Aspose.OMR for Cloud API Reference version: 1.1
...
asposeomrcloud::ApiFactory for non-Moosey usage.
...
The tokens will be placed in a L<asposeomrcloud::Configuration> instance
...
Returns an API factory object. You probably won't need to call this directly.
        ...
        $self->api_factory('Pet'); # returns a asposeomrcloud::PetApi instance
