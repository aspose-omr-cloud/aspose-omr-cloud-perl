...
#
package asposeomrcloud::Object::OmrResponseContent;
...
__PACKAGE__->class_documentation({description => 'Represents information about part of the text.',
...
__PACKAGE__->method_documentation({
    'template_id' => {
    	...
    	description => 'GUID string that is used to identify template on server This value is assigned after Template Correction and used later in Template Finalization and Image Recognition',
    	format => '',
    	read_only => '',
    		},
    'execution_time' => {
    	datatype => 'double',
    	base_name => 'ExecutionTime',
    ...
    'response_files' => {
    	...
    	base_name => 'ResponseFiles',
    	description => 'This structure holds array of files returned in response Type and content of files differes depending on action',
    	format => '',
    	read_only => '',
    		},
    'info' => {
    	datatype => 'OmrResponseInfo',
    	base_name => 'Info',
    	description => '',
    	format => '',
    	read_only => '',
