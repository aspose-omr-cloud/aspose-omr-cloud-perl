...
#
package asposeomrcloud::Object::OMRResponse;
...
__PACKAGE__->class_documentation({description => 'Represents information about response after OMR.',
                                  class => 'OMRResponse',
                                  required => [], # TODO
}                                 );
